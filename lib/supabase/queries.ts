...
const RECIPE_FIELDS = "id, title, slug, category, description, seo_title, seo_keywords, ingredients, instructions, image_url, image_position, servings, kcal_per_person, prep_time_minutes, cook_time_minutes, subcategories, created_at, updated_at, submitted_by";
