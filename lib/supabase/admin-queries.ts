...
const RECIPE_FIELDS =
  "id, title, slug, category, description, seo_title, seo_keywords, ingredients, instructions, image_url, servings, subcategories, created_at, updated_at, submitted_by, profiles:submitted_by(username)";
