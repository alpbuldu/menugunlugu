        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a
              ...
              className="mt-2 flex items-center gap-2 bg-black hover:bg-warm-900 transition-colors rounded-xl px-3 py-2 border border-warm-600"
            >
              ...
              <div className="flex flex-col items-start">
                <span className="text-[9px] text-warm-300 leading-tight">App Store'da</span>
                <span className="text-xs font-semibold text-white leading-tight">İndir</span>
              </div>
            </a>
          </div>
