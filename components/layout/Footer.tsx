        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a
              ...
              className="mt-2 flex items-center gap-1.5 border border-warm-500 hover:border-white rounded-lg px-3 py-1.5 transition-all hover:bg-white/5 group"
            >
              ...
              <span className="text-xs font-medium text-warm-200 group-hover:text-white transition-colors">App Store'da İndir</span>
            </a>
          </div>
