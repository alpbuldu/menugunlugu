...
export default function Chatbot() {
  ...
  function pickCategory(cat: Category) {
    ...
    setMsgs(prev => [
      ...
      bot(`Güzel! ${CAT_TR[cat]} için evindeki malzemeleri yaz. 🍳\n\nHer malzemeyi tek tek yaz → Enter'a bas → sonraki malzemeyi yaz. (En fazla 10 malzeme)\n\n💡 Tuz, şeker, su, yağ, baharatlar gibi temel malzemeleri yazmana gerek yok — bunlar zaten arama dışında tutulur.`),
    ]);
