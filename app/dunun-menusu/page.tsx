...
export default async function ArchivePage() {
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 pb-8 sm:pb-12">
      {/* Yatay banner */}
      ...
      <p className="text-sm text-warm-500 mb-4">Geçmiş günlerin menülerini takvimden seçerek inceleyin.</p>
      <Calendar />
