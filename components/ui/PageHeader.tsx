...
export default function PageHeader({ title, description, emoji, className = "bg-warm-50 border-warm-100" }: PageHeaderProps) {
  return (
    <div className={`text-center py-7 sm:py-10 mb-6 sm:mb-8 rounded-2xl border ${className}`}>
