        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a
              ...
              className="mt-3 flex items-center gap-3 border border-warm-500 hover:border-white rounded-xl px-4 py-2.5 transition-all hover:bg-white/5 group"
            >
              ...
              <div className="flex flex-col items-start">
                <span className="text-[10px] text-warm-400 group-hover:text-warm-200 leading-tight transition-colors">App Store'da</span>
                <span className="text-sm font-semibold text-white leading-tight">İndir</span>
              </div>
            </a>
          </div>
